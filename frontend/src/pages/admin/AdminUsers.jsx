  ...
  return (
    <AdminLayout
      ...
      actions={
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl font-bold text-xs text-white shadow-md transition-all hover:opacity-90 cursor-pointer"
    ...
    >
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        {[
          { icon: <Users className="w-5 h-5" />, color: '#6C5CE7', bg: 'rgba(108,92,231,0.1)', label: 'Total Users', val: totalUsers },
          { icon: <UserCheck className="w-5 h-5" />, color: '#00b894', bg: 'rgba(0,184,148,0.1)', label: 'Active Users', val: activeUsers },
          { icon: <UserX className="w-5 h-5" />, color: '#d63031', bg: 'rgba(214,48,49,0.1)', label: 'Suspended', val: suspendedUsers },
          { icon: <Shield className="w-5 h-5" />, color: '#0984e3', bg: 'rgba(9,132,227,0.1)', label: 'Instructors/Admins', val: instructorsAdmins },
        ].map((c) => (
          <div key={c.label} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 flex items-center gap-4 shadow-sm">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{ backgroundColor: c.bg }}>
              <span style={{ color: c.color }}>{c.icon}</span>
            </div>
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">{c.label}</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white leading-tight">{c.val.toLocaleString()}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      {/* Filters */}
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4 flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                <th className="px-5 py-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">User</th>
                <th className="px-5 py-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Role</th>
                <th className="px-5 py-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Status</th>
                <th className="px-5 py-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Joined</th>
