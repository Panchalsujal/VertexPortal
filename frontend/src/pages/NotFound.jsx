...
export default function NotFound() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#f8fafc] dark:bg-[#0b0f19] text-gray-900 dark:text-slate-100 font-[Inter,sans-serif] flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-purple-500 selection:text-white">
