...
export const config = {
  ...
  RESEND_API_KEY: process.env.RESEND_API_KEY || "re_ci_mock_test_key_123456",
  EMAIL_FROM:
  ...
  IMAGEKIT_PUBLIC_KEY: (process.env.IMAGEKIT_PUBLIC_KEY || "ci_mock_public_key")?.trim(),
  IMAGEKIT_PRIVATE_KEY: (process.env.IMAGEKIT_PRIVATE_KEY || "ci_mock_private_key")?.trim(),
  IMAGEKIT_URL_ENDPOINT: (process.env.IMAGEKIT_URL_ENDPOINT || "https://ik.imagekit.io/ci_mock")?.trim(),
  RAZORPAY_KEY_ID: process.env.RAZORPAY_KEY_ID || "rzp_test_mock",
  RAZORPAY_SECRET_ID: process.env.RAZORPAY_SECRET_ID || "rzp_test_mock_secret",
  FRONTEND_URL: process.env.FRONTEND_URL || "http://localhost:5173",
  PORT: process.env.PORT || 3000,
  MISTRAL_API_KEY: process.env.MISTRAL_API_KEY || "mistral_test_mock_key",
  ...
  STREAM_API_KEY: process.env.STREAM_API_KEY || "stream_test_mock_key",
  STREAM_API_SECRET: process.env.STREAM_API_SECRET || "stream_test_mock_secret",
